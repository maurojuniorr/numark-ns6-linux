...
Sincronização de Estado: LEDs de botões, faders e seletores de FX sincronizam automaticamente ao abrir o software.(quase)
...
📥 Instalação e Teste
Clone o repositório e acesse o branch de desenvolvimento:
